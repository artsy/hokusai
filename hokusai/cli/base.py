...
@base.command(context_settings=CONTEXT_SETTINGS)
@click.option('-f', '--filename', type=click.STRING, help='Use the docker-compose Yaml file in the ./hokusai directory (default: build.yml)')
@click.option('-v', '--verbose', type=click.BOOL, is_flag=True, help='Verbose output')
...
@click.option('-f', '--filename', type=click.STRING, help='Use the docker-compose Yaml file in the ./hokusai directory (default: test.yml)')
