...
@click.option('-f', '--filename', type=click.STRING, help='Use the docker-compose Yaml file name in the ./hokusai directory (default development.yml)')
...
@click.option('-fi', '--filename', type=click.STRING, help='Use the docker-compose Yaml file name in the ./hokusai directory (default development.yml)')
@click.option('-v', '--verbose', type=click.BOOL, is_flag=True, help='Verbose output')
