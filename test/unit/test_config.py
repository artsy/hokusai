...
class TestConfigSetup(HokusaiUnitTestCase):
  ...
  def test_check_hokusai_required_version(self):
    ...
    self.assertTrue(not self.config._check_required_version('~=0.1', '1.0'))
    self.assertTrue(self.config._check_required_version('==0.0.1', '0.0.1'))
    self.assertTrue(not self.config._check_required_version('==0.0.1', '0.0.2'))
    self.assertTrue(not self.config._check_required_version('==1.0', '0.2'))
    ...
    self.assertTrue(not self.config._check_required_version('<1.1', '2.0.2'))
    self.assertTrue(not self.config._check_required_version('<=0.0.2', '2.2'))
    ...
    self.assertTrue(self.config._check_required_version('!=0.0.1', '1.2.3'))
    self.assertTrue(not self.config._check_required_version('!=0.0.1', '0.0.1'))
    self.assertTrue(not self.config._check_required_version('!=0.1.*', '0.1.1'))
    self.assertTrue(self.config._check_required_version('===1.0+trololo', '1.0+trololo'))
    self.assertTrue(not self.config._check_required_version('===1.0+trololo', '1.0+tralala'))
